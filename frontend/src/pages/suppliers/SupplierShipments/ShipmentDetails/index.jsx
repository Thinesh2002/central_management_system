  ...
  return (
    <div className="min-h-screen bg-[#07111f] text-white p-6">
      <div className="max-w-[1600px] mx-auto space-y-6">
        <div className="rounded-3xl bg-gradient-to-br from-[#132238] to-[#0b1422] border border-white/10 p-6 shadow-2xl shadow-black/40">
          <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-5">
            <div>
              <p className="text-sm text-yellow-400 font-medium tracking-wide flex items-center gap-2">
                <Truck size={16} />
                Supplier Management
              </p>
              ...
              <p className="text-slate-300 mt-2">
                Track shipments, order counts, ordered quantity and total cost.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-3">
              <Link
                to="/suppliers"
                className="cursor-pointer px-5 py-3 rounded-2xl bg-[#132238] border border-white/10 text-white font-semibold hover:border-yellow-400 hover:shadow-lg hover:shadow-yellow-400/20 transition-all flex items-center gap-2"
              >
                <ArrowLeft size={18} />
                Back
              </Link>
              ...
              <button
                ...
                className="cursor-pointer px-5 py-3 rounded-2xl bg-yellow-400 text-[#07111f] font-semibold shadow-lg shadow-yellow-400/20 hover:shadow-yellow-400/50 hover:scale-[1.03] transition-all flex items-center gap-2"
              >
                <Plus size={18} />
                New Shipment
              </button>
