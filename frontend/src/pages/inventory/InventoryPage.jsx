        ...
        <form onSubmit={submitForm} className="w-full max-w-5xl rounded-lg border border-slate-700 bg-[#0b1220] shadow-2xl">
          ...
          <div className="space-y-3 p-4">
            <div className="rounded-md border border-slate-800 bg-[#070b16] p-3">
              <p className="mb-2 text-[10px] font-semibold uppercase text-orange-300">1. First SKU Search</p>
              <div className="flex gap-2">
                <input value={skuSearch} onChange={(e) => setSkuSearch(e.target.value)} placeholder="Enter product SKU or variant SKU" className="h-9 flex-1 rounded-md border border-slate-700 bg-[#020617] px-3 text-[12px] font-semibold outline-none focus:border-orange-400" />
                <button type="button" onClick={searchProducts} className="h-9 rounded-md bg-orange-400 px-3 text-[12px] font-semibold text-slate-950">{productLoading ? "Searching..." : "Search"}</button>
              </div>
            ...
            <div className="grid gap-3 md:grid-cols-3">
              {[
                ...
                <label key={n} className="space-y-1">
                  ...
                  <input type={t} value={form[n] ?? ""} onChange={(e) => setField(n, e.target.value)} className="h-9 w-full rounded-md border border-slate-700 bg-[#070b16] px-3 text-[12px] font-semibold text-slate-100 outline-none focus:border-orange-400" />
                </label>
              ))}
              <label className="space-y-1">
                <span className="text-[10px] font-semibold uppercase text-slate-500">Status</span>
                <select value={form.status || "active"} onChange={(e) => setField("status", e.target.value)} className="h-9 w-full rounded-md border border-slate-700 bg-[#070b16] px-3 text-[12px] font-semibold text-slate-100 outline-none focus:border-orange-400">
          ...
          <div className="flex justify-end gap-2 border-t border-slate-800 px-4 py-3">
            ...
            <button disabled={saving} className="inline-flex h-8 items-center gap-1.5 rounded-md bg-orange-400 px-3 text-[12px] font-semibold text-slate-950 disabled:opacity-60">
