...
const update = asyncHandler(async (req, res) => {
  ...
  await writeProductLog(req, "UPDATE_PRODUCT_INVENTORY", req.params.id, before, updated);
...
const remove = asyncHandler(async (req, res) => {
  ...
  await writeProductLog(req, "DELETE_PRODUCT_INVENTORY", req.params.id, removed, null);
